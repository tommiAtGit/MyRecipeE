...
import com.myProjects.myRecipe.application.controler.MealControler;
...
public class MealControlerImpl implements MealControler {
	...
	static Logger log = Logger.getLogger(MealControlerImpl.class.getName());
	private MealServiceDAO mealService = null;


	
	public MealControlerImpl(String persistenceUnitName) {
